...
public class Scaner {
	...
	public Scaner(String qr_code, long id, Date data_leitura, long imei_cel) {
		super();
	...
	public Scaner(String qr_code, Date data_leitura, long imei_cel) {
		super();
		this.qr_code = qr_code;
		this.data_leitura = data_leitura;
		this.imei_cel = imei_cel;
	...
	public String toString() {
		return "Scaner [qr_code=" + qr_code + ", id=" + id + ", data_leitura="
